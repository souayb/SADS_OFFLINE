...
if color_blind :
        new_title = f"""<center> <h2> <p style="font-family:fantasy; color:{color_palette['good']}; font-size: 24px;"> SADS: Shop-floor Anomaly Detection Testing</p> </h2></center>"""
        st.markdown(new_title, unsafe_allow_html=True)

else:
    new_title = '<center> <h2> <p style="font-family:fantasy; color:#82270c; font-size: 24px;"> SADS: Shop-floor Anomaly Detection Testing</p> </h2></center>'
    st.markdown(new_title, unsafe_allow_html=True)
